...
@RabbitDslMarker
fun PluginContext.channel(id: Int, autoClose: Boolean = false, block: ChannelContext.() -> Unit): Channel {
...
@RabbitDslMarker
fun PluginContext.connection(id: String, autoClose: Boolean = false, block: ConnectionContext.() -> Unit): Connection {
...
@RabbitDslMarker
fun PluginContext.libConnection(id: String, autoClose: Boolean = false, block: Connection.() -> Unit): Connection {
    return connectionManager.getConnection(id)
        .also {
            it.apply(block)
            if (autoClose) connectionManager.closeConnection(id)
